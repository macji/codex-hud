...
export interface RawStdinData {
  ...
  reasoning_effort?: string | { level?: string | null } | null;
  effort?: string | { level?: string | null } | null;
  session_id?: string;
  session?: { id?: string; name?: string; started_at?: string | number | null };
  context_window?: {
  ...
  rate_limits?: {
    ...
    weekly?: { used_percentage?: number | null; resets_at?: string | number | null } | null;
  } | null;
  tools?: ToolEntry[];
  agents?: AgentEntry[];
  todos?: TodoItem[];
...
export function emptyContext(): ContextInfo {
  return {
    windowSize: null,
    usedTokens: null,
    inputTokens: 0,
