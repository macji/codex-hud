import { emptyUsageLimits } from '../types.js';
function percentFromEnv(...names) {
...
export function snapshotFromCodexEnv() {
    ...
    const snapshot = { model, reasoningEffort };
...
//# sourceMappingURL=codex-env-adapter.js.map